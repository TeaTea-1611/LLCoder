...
export type Query = {
  ...
  blogComments: PagtinatedComment;
  me?: Maybe<User>;
...
export type BlogInfoFragment = { __typename?: 'Blog', id: string, title: string, text: string, createdAt: any, updatedAt: any };

export type BlogMutationResponseFragment = { __typename?: 'BlogMutationResponse', code: number, success: boolean, message?: string | null, blog?: { __typename?: 'Blog', id: string, title: string, text: string, createdAt: any, updatedAt: any } | null, errors?: Array<{ __typename?: 'FieldError', field: string, message: string }> | null };

export type CommentTypeFragment = { __typename?: 'BlogComment', id: string, comment: string, parentId?: string | null, replyCount: number, reactionsCount: number, createdAt: any, updatedAt: any, user: { __typename?: 'User', id: string, nickname: string, avatar: string }, reactions: Array<{ __typename?: 'BlogCommentReactions', userId: string, type: string }> };
...
export type UserInfoFragment = { __typename?: 'User', id: string, nickname: string, role: string, confirmed: boolean, avatar: string, exp: number, dob?: any | null, theme: string, language: string, lastLogin?: any | null, createdAt: any, updatedAt: any };

export type UserMutationResponseFragment = { __typename?: 'UserMutationResponse', code: number, success: boolean, message?: string | null, user?: { __typename?: 'User', id: string, nickname: string, role: string, confirmed: boolean, avatar: string, exp: number, dob?: any | null, theme: string, language: string, lastLogin?: any | null, createdAt: any, updatedAt: any } | null, errors?: Array<{ __typename?: 'FieldError', field: string, message: string }> | null };
...
export type UploadImageMarkDownMutation = { __typename?: 'Mutation', uploadImage: { __typename?: 'UploadImageResponse', url?: string | null } };
...
export type CreateBlogMutation = { __typename?: 'Mutation', createBlog: { __typename?: 'BlogMutationResponse', code: number, success: boolean, message?: string | null, blog?: { __typename?: 'Blog', id: string, title: string, text: string, createdAt: any, updatedAt: any } | null, errors?: Array<{ __typename?: 'FieldError', field: string, message: string }> | null } };
...
export type SetLanguageSettingsMutation = { __typename?: 'Mutation', setLanguageSetting: { __typename?: 'LanguageSettingResponse', language: string } };
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'UserMutationResponse', code: number, success: boolean, message?: string | null, user?: { __typename?: 'User', id: string, nickname: string, role: string, confirmed: boolean, avatar: string, exp: number, dob?: any | null, theme: string, language: string, lastLogin?: any | null, createdAt: any, updatedAt: any } | null, errors?: Array<{ __typename?: 'FieldError', field: string, message: string }> | null } };
...
export type SetThemeSettingsMutation = { __typename?: 'Mutation', setThemeSetting: { __typename?: 'ThemeSettingResponse', theme: string } };
...
export type BlogQuery = { __typename?: 'Query', blog?: { __typename?: 'Blog', id: string, title: string, text: string, commentsCount: number, likesCount: number, createdAt: any, updatedAt: any, user: { __typename?: 'User', id: string, nickname: string, avatar: string }, tags: Array<{ __typename?: 'BlogTag', name: string }> } | null };

export type MeQueryVariables = Exact<{ [key: string]: never; }>;


export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'User', id: string, nickname: string, role: string, confirmed: boolean, avatar: string, exp: number, dob?: any | null, theme: string, language: string, lastLogin?: any | null, createdAt: any, updatedAt: any } | null };
...
export type BlogCommentsQuery = { __typename?: 'Query', blogComments: { __typename?: 'PagtinatedComment', totalCount: number, cursor: any, hashMore: boolean, comments?: Array<{ __typename?: 'BlogComment', id: string, comment: string, parentId?: string | null, replyCount: number, reactionsCount: number, createdAt: any, updatedAt: any, user: { __typename?: 'User', id: string, nickname: string, avatar: string }, reactions: Array<{ __typename?: 'BlogCommentReactions', userId: string, type: string }> }> | null } };
...
export type PagtinatedBlogsQuery = { __typename?: 'Query', pagtinatedBlogs: { __typename?: 'PagtinatedBlogs', totalCount: number, cursor: any, hashMore: boolean, blogs?: Array<{ __typename?: 'Blog', id: string, title: string, text: string, commentsCount: number, likesCount: number, createdAt: any, updatedAt: any, user: { __typename?: 'User', id: string, nickname: string, avatar: string }, tags: Array<{ __typename?: 'BlogTag', name: string }> }> | null } };
...
export const UploadImageMarkDownDocument = gql`
  ...
  uploadImage(image: $image) {
    ...
    `;
export type UploadImageMarkDownMutationFn = Apollo.MutationFunction<UploadImageMarkDownMutation, UploadImageMarkDownMutationVariables>;
 ...
 * });
 */
export function useUploadImageMarkDownMutation(baseOptions?: Apollo.MutationHookOptions<UploadImageMarkDownMutation, UploadImageMarkDownMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UploadImageMarkDownMutation, UploadImageMarkDownMutationVariables>(UploadImageMarkDownDocument, options);
      }
export type UploadImageMarkDownMutationHookResult = ReturnType<typeof useUploadImageMarkDownMutation>;
export type UploadImageMarkDownMutationResult = Apollo.MutationResult<UploadImageMarkDownMutation>;
export type UploadImageMarkDownMutationOptions = Apollo.BaseMutationOptions<UploadImageMarkDownMutation, UploadImageMarkDownMutationVariables>;
...
export const SetLanguageSettingsDocument = gql`
  ...
  setLanguageSetting(languageType: $languageType) {
    ...
    `;
export type SetLanguageSettingsMutationFn = Apollo.MutationFunction<SetLanguageSettingsMutation, SetLanguageSettingsMutationVariables>;
 ...
 * });
 */
export function useSetLanguageSettingsMutation(baseOptions?: Apollo.MutationHookOptions<SetLanguageSettingsMutation, SetLanguageSettingsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SetLanguageSettingsMutation, SetLanguageSettingsMutationVariables>(SetLanguageSettingsDocument, options);
      }
export type SetLanguageSettingsMutationHookResult = ReturnType<typeof useSetLanguageSettingsMutation>;
export type SetLanguageSettingsMutationResult = Apollo.MutationResult<SetLanguageSettingsMutation>;
export type SetLanguageSettingsMutationOptions = Apollo.BaseMutationOptions<SetLanguageSettingsMutation, SetLanguageSettingsMutationVariables>;
...
export const SetThemeSettingsDocument = gql`
  ...
  setThemeSetting(themeType: $themeType) {
    ...
    `;
export type SetThemeSettingsMutationFn = Apollo.MutationFunction<SetThemeSettingsMutation, SetThemeSettingsMutationVariables>;
 ...
 * });
 */
export function useSetThemeSettingsMutation(baseOptions?: Apollo.MutationHookOptions<SetThemeSettingsMutation, SetThemeSettingsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SetThemeSettingsMutation, SetThemeSettingsMutationVariables>(SetThemeSettingsDocument, options);
      }
export type SetThemeSettingsMutationHookResult = ReturnType<typeof useSetThemeSettingsMutation>;
export type SetThemeSettingsMutationResult = Apollo.MutationResult<SetThemeSettingsMutation>;
export type SetThemeSettingsMutationOptions = Apollo.BaseMutationOptions<SetThemeSettingsMutation, SetThemeSettingsMutationVariables>;
 ...
 * });
 */
export function useBlogCommentsQuery(baseOptions: Apollo.QueryHookOptions<BlogCommentsQuery, BlogCommentsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<BlogCommentsQuery, BlogCommentsQueryVariables>(BlogCommentsDocument, options);
      }
export function useBlogCommentsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BlogCommentsQuery, BlogCommentsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<BlogCommentsQuery, BlogCommentsQueryVariables>(BlogCommentsDocument, options);
        }
export type BlogCommentsQueryHookResult = ReturnType<typeof useBlogCommentsQuery>;
export type BlogCommentsLazyQueryHookResult = ReturnType<typeof useBlogCommentsLazyQuery>;
export type BlogCommentsQueryResult = Apollo.QueryResult<BlogCommentsQuery, BlogCommentsQueryVariables>;
